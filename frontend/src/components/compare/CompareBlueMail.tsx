...
const features = [
  ...
  { name: 'Cross-Platform Apps', getanswers: true, competitor: true },
  { name: 'Cluster Emails', getanswers: true, competitor: true },
  { name: 'Unified Inbox', getanswers: true, competitor: true },
  { name: 'Smart Notifications', getanswers: true, competitor: true },
  { name: 'Dark Mode', getanswers: true, competitor: true },
  ...
  { name: 'Exchange Support', getanswers: true, competitor: true },
  { name: 'Free Version', getanswers: true, competitor: true },
];

const testimonials = [
  {
    quote: "BlueMail is convenient on all my devices, but GetAnswers writes my emails. That's a completely different level of help.",
    author: "Carlos Mendez",
    role: "Remote Worker, Spain",
    metric: "4 hrs saved daily",
  },
  {
    quote: "I used BlueMail for years across devices. Then I discovered AI could actually handle responses. Game changer.",
    author: "Maria Santos",
    role: "Business Owner, Portugal",
    metric: "80% auto-drafted",
  },
];
...
const comparisonPoints = [
  {
    title: 'Core Value',
    getanswers: 'AI reads your emails and writes contextual responses. You approve and send.',
    competitor: 'Unified inbox across all devices. You still write everything.',
    winner: 'getanswers',
  },
  {
    title: 'Cross-Platform',
    getanswers: 'Web-first with native-like experience on any platform.',
    competitor: 'Native apps for iOS, Android, Windows, Mac, and Linux.',
    winner: 'competitor',
  },
  {
    title: 'Email Organization',
    getanswers: 'AI-powered smart inbox. Automatically prioritizes and categorizes.',
    competitor: 'Cluster feature groups similar emails. Manual organization.',
    winner: 'getanswers',
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            GetAnswers vs<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">BlueMail</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
            Cross-platform email client vs AI that writes your emails.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl p-8">
            ...
            <p className="text-gray-300 text-lg">
              <strong className="text-white">BlueMail</strong> offers excellent cross-platform email access.
              <strong className="text-white"> GetAnswers</strong> uses AI to actually write your responses. Need email everywhere? BlueMail. Need AI writing your emails? GetAnswers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-12">AI Writing vs Cross-Platform</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-6">
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start gap-2"><Check className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" /><span>AI drafts complete responses</span></li>
                <li className="flex items-start gap-2"><Check className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" /><span>Learns your communication style</span></li>
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-400">BlueMail: Everywhere</h3>
              </div>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start gap-2"><Check className="w-5 h-5 text-gray-500 flex-shrink-0 mt-0.5" /><span>Native apps everywhere</span></li>
                <li className="flex items-start gap-2"><Check className="w-5 h-5 text-gray-500 flex-shrink-0 mt-0.5" /><span>Unified inbox</span></li>
                <li className="flex items-start gap-2"><X className="w-5 h-5 text-gray-500 flex-shrink-0 mt-0.5" /><span>No AI writing assistance</span></li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div key={index} className="bg-slate-800/50 border border-slate-700 rounded-xl overflow-hidden">
                ...
                <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-700">
                  ...
                  <div className={`p-6 ${point.winner === 'competitor' ? 'bg-violet-500/5' : ''}`}>
                    <div className="flex items-center gap-2 mb-3">
                      <span className="font-semibold text-gray-400">BlueMail</span>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700">
                  ...
                  <th className="text-center py-4 px-4 text-gray-300">BlueMail</th>
                </tr>
              </thead>
              <tbody>
                {features.map((f, i) => (
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">AI That Writes Your Emails</h2>
          <p className="text-xl text-gray-400 mb-8">More than access—actual automated responses.</p>
          <Link to="/register" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all">
