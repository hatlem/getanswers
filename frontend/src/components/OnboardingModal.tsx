...
import { X, ArrowRight, ArrowLeft, Check, Mail, Zap, Shield, Sparkles } from 'lucide-react';

type OnboardingStep = 'welcome' | 'connect' | 'preferences';
...
export function OnboardingModal({ isOpen, onClose, onConnectGmail }: OnboardingModalProps) {
  ...
  const stepIndex = currentStep === 'welcome' ? 0 : currentStep === 'connect' ? 1 : 2;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <motion.div
        ...
        className="bg-surface-elevated rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden border border-surface-border"
      >
        {/* Header */}
            ...
            {currentStep === 'welcome' && (
              ...
              >
                ...
                <div className="space-y-3">
                  {[
                    { icon: Mail, title: 'Connect your email', desc: 'We support Gmail and Outlook' },
            ...
            {currentStep === 'connect' && (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <button
                    disabled
                    className="w-full flex items-center justify-center gap-3 p-4 rounded-xl bg-surface-card border border-surface-border opacity-50 cursor-not-allowed"
                  >
                    <svg className="w-6 h-6" viewBox="0 0 24 24">
                      <path fill="#0078D4" d="M21.49 6.97l-9-5.5a1 1 0 0 0-1 0l-9 5.5A1 1 0 0 0 2 7.87v8.26a1 1 0 0 0 .49.86l9 5.5a1 1 0 0 0 1 0l9-5.5a1 1 0 0 0 .51-.86V7.87a1 1 0 0 0-.51-.9z"/>
                    </svg>
                    <span className="font-medium text-text-muted">Outlook (Coming soon)</span>
                  </button>
                </div>
